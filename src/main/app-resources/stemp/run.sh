...
string_inp=$(head -n 1 file_input.cfg)
leng=${#string_inp}
mv ${PROCESSING_HOME}/${string_inp:0:leng-4}_TEMPclass.tif ${PROCESSING_HOME}/${string_inp:0:leng-4}_TEMPclass-${volcano}.tif
mv ${PROCESSING_HOME}/${string_inp:0:leng-4}_TEMP.tif ${PROCESSING_HOME}/${string_inp:0:leng-4}_TEMP-${volcano}.tif
generateQuicklook ${PROCESSING_HOME}/${string_inp:0:leng-4}_TEMPclass-${volcano}.tif ${PROCESSING_HOME}
#gdal_translate -scale -10 10 0 255 -ot Byte -of PNG ${string_inp:0:leng-4}_TEMP.tif ${string_inp:0:leng-4}_TEMP.png
#listgeo -tfw ${string_inp:0:leng-4}_TEMP.tif
#mv ${string_inp:0:leng-4}_TEMP.tfw ${string_inp:0:leng-4}_TEMP.pngw
...
>>>>>>> a97b4638caf43210342d421dbfcbe25e90bf04e3
